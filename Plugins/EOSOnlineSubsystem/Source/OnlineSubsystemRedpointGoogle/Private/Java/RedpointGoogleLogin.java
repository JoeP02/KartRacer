        ...
        this.oneTapClient.beginSignIn(this.signInRequest)
            .addOnSuccessListener(
                ...
                new OnSuccessListener<BeginSignInResult>() {
                    @Override public void onSuccess(BeginSignInResult result)
                    {
                        try
                        {
            ...
            .addOnFailureListener(this.activity, new OnFailureListener() {
                @Override public void onFailure(@NonNull Exception e)
                {
                    printDebug(
                        ...
                        "Received onFailure callback while calling oneTapClient beginSignIn: " + e.toString());
                    e.printStackTrace();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        case REQ_ONE_TAP:
            try
            {
                ...
                this.billingClient =
                    BillingClient.newBuilder(this.activity).setListener(this).enablePendingPurchases().build();
                this.makeBillingRequest(new BillingRequestOperation() {
                    @Override public void performOperation(boolean didConnect, String connectionError)
                    {
                        if (!didConnect)
                        {
            ...
            @Override public void performOperation(boolean didConnect, String connectionError)
            {
                ...
                RedpointGoogleLogin.this.billingClient.consumeAsync(
                    ...
                    new ConsumeResponseListener() {
                        @Override public void onConsumeResponse(@NonNull BillingResult billingResult, @NonNull String s)
                        {
