...
bool FOnlineSubsystemRedpointGoogle_EOS_CanQueryOfferById::RunTest(const FString &InParam)
{
    ...
    FAutomationTestFramework::Get().EnqueueLatentCommand(MakeShareable(new FRedpointGoogleQueryOfferById(this, FName(TEXT("RedpointEOS")), TArray<FUniqueOfferId>{TEXT("test_iap")})));
