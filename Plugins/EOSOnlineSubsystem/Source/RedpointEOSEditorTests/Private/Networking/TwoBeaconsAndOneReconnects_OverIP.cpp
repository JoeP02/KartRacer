...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    ...
    "OnlineSubsystemEOS.Networking.TwoBeaconsAndOneReconnects.OverIP",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

bool FTwoBeaconsAndOneReconnects_OverIP::RunTest(const FString &InParam)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND_PATCHED(
        FSpawnControlledBeaconOnPIE(this, 0, TestHelpers::Port(9000), TEXT("A"), TEXT("NetMode=ForceIP")));
    ADD_LATENT_AUTOMATION_COMMAND_PATCHED(
        FSpawnControlledBeaconOnPIE(this, 0, TestHelpers::Port(9001), TEXT("B"), TEXT("NetMode=ForceIP")));
