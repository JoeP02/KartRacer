...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FStartEmptyMapInEditor_Standalone_Auth_OverIP,
    "OnlineSubsystemEOS.Networking.StartEmptyMapInEditor.Standalone_Auth_OverIP",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

bool FStartEmptyMapInEditor_Standalone_Auth_OverIP::RunTest(const FString &InParam)
{
