...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FStartEmptyMapInEditor_ListenServer_NoAuth_FullStack,
    "OnlineSubsystemEOS.Networking.StartEmptyMapInEditor.ListenServer_NoAuth_FullStack",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

bool FStartEmptyMapInEditor_ListenServer_NoAuth_FullStack::RunTest(const FString &InParam)
{
