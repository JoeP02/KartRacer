...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    ...
    "OnlineSubsystemEOS.Networking.ConnectToBeaconsInSequence.OverP2P",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

bool FConnectToBeaconsInSequence_OverP2P::RunTest(const FString &InParam)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND_PATCHED(
        FSpawnBeaconOnPIE(this, 0, TestHelpers::Port(9002), TEXT("NetMode=ForceP2P")));
    ADD_LATENT_AUTOMATION_COMMAND_PATCHED(
        FSpawnBeaconOnPIE(this, 1, TestHelpers::Port(9003), TEXT("NetMode=ForceP2P")));
