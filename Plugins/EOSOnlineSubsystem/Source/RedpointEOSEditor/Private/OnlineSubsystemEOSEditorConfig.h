    ...
    UPROPERTY(
        ...
        meta =
            (DisplayName = "On Sign In or Create Account",
             ...
             MustImplement = "/Script/OnlineSubsystemRedpointEOS.EOSUserInterface_SignInOrCreateAccount"))
    ...
    UPROPERTY(
        ...
        meta =
            (DisplayName = "On Enter Device PIN Code",
             MetaClass = "/Script/UMG.UserWidget",
             MustImplement = "/Script/OnlineSubsystemRedpointEOS.EOSUserInterface_EnterDevicePinCode"))
