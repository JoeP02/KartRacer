...
bool FAuthorizeLauncher::Launch(bool bInteractive)
{
    ...
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("Executing: %s"), *AuthorizerBat);
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("With arguments: %s"), *FinalArguments);
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("In working directory: %s"), *WorkingDirectory);
    ...
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("Authorizer return code: %d"), ReturnCode);
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("Authorizer stdout: %s"), *Stdout);
    UE_LOG(LogRedpointEOSEditor, Verbose, TEXT("Authorizer stderr: %s"), *Stderr);
