...
DECLARE_LOG_CATEGORY_EXTERN(LogDiscordRuntime, All, All);

class REDPOINTDISCORDGAMESDKRUNTIME_API FRedpointDiscordGameSDKRuntimeModule : public IModuleInterface
{
private:
    void *DynamicLibraryHandle;

public:
    FRedpointDiscordGameSDKRuntimeModule()
