    ...
    FOnlineExternalCredentialsRefreshComplete OnComplete)
{
    if (!bWasSuccessful)
    {
        UE_LOG(LogRedpointEOSPlatformDefault, Error, TEXT("Unable to refresh encrypted app ticket from GOG"));
    ...
    UE_LOG(LogRedpointEOSPlatformDefault, Verbose, TEXT("Refreshed with new GOG app ticket: %s"), *AppTicket);
    ...
    FAuthenticationGraphNodeOnDone InOnDone)
{
    if (!bWasSuccessful)
    {
        UE_LOG(LogRedpointEOSPlatformDefault, Error, TEXT("Unable to get encrypted app ticket from GOG"));
    ...
    UE_LOG(LogRedpointEOSPlatformDefault, Verbose, TEXT("Authenticating with GOG app ticket: %s"), *AppTicket);
