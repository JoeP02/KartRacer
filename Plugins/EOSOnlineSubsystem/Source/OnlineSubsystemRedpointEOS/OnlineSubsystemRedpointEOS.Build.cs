...
public class OnlineSubsystemRedpointEOS : ModuleRules
{
	...
	{
		Module.PrivateIncludePaths.Add(Path.Combine(Module.GetModuleDirectory("OnlineSubsystemRedpointEOS"), ".."));
		Module.PublicIncludePaths.Add(Path.Combine(Module.GetModuleDirectory("OnlineSubsystemRedpointEOS"), ".."));

#if UE_5_3_OR_LATER
		Module.PrivateDefinitions.Add("UE_5_3_OR_LATER=1");
#endif
#if UE_5_2_OR_LATER
		Module.PrivateDefinitions.Add("UE_5_2_OR_LATER=1");
#endif
#if UE_5_1_OR_LATER
		Module.PrivateDefinitions.Add("UE_5_1_OR_LATER=1");
#endif
#if UE_5_0_OR_LATER
		Module.PrivateDefinitions.Add("UE_5_0_OR_LATER=1");
#endif
#if UE_4_27_OR_LATER
		Module.PrivateDefinitions.Add("UE_4_27_OR_LATER=1");
#endif
	}
