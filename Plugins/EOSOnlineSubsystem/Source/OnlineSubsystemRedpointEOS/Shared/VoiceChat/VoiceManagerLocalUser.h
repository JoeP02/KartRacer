...
private:
    ...
    public:
        ...
        EOS_HRTCAudio EOSRTCAudio;
        FString RoomName;
        TSharedPtr<const FOnlinePartyIdEOS> LobbyId;
    ...
    void RegisterLobbyChannel(
        ...
        EVoiceChatChannelType ChannelType);
    void UnregisterLobbyChannel(const TSharedRef<const FOnlinePartyIdEOS> &InLobbyId);
...
public:
    ...
    virtual ~FEOSVoiceManagerLocalUser();
    void RegisterEvents();
