...
class ONLINESUBSYSTEMREDPOINTEOS_API FPerformOpenIdLoginForCrossPlatformAutomatedTestingNode
...
public:
    ...
    virtual ~FPerformOpenIdLoginForCrossPlatformAutomatedTestingNode() = default;
