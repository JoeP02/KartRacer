...
class ONLINESUBSYSTEMREDPOINTEOS_API FIssueJwtForCrossPlatformAutomatedTestingNode : public FAuthenticationGraphNode
{
private:
    void OnHttpResponse(
...
public:
    ...
    virtual ~FIssueJwtForCrossPlatformAutomatedTestingNode() = default;
