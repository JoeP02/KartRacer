...
void FFriendDatabase::Archive(FArchive &Ar)
{
    ...
    if (Ar.IsSaving())
    {
        ...
        TArray<TPair<FUniqueNetIdRef, FSerializedRecentPlayer>> RecentPlayersSorted;
    ...
    FFriendDatabaseOperationComplete OnComplete)
{
    ...
    if (auto UserCloud = this->UserCloudImpl.Pin())
    {
        ...
        UE_LOG(LogRedpointEOSFriends, Verbose, TEXT("Cross-platform friends database passed hash check."));
