    ...
    FServerOrchestratorGetPortMappingsComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Agones: Received game server JSON from Agones HTTP sidecar: %s"), *Json);
    ...
    FServerOrchestratorServingTrafficComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Agones: Marked game server as ready for connections"));
    OnComplete.ExecuteIfBound();
}
    ...
    FServerOrchestratorSessionStartedComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Agones: Marked game server as allocated"));
    OnComplete.ExecuteIfBound();
}
    ...
    FServerOrchestratorShutdownComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Agones: Notified that the game server should shutdown"));
    OnComplete.ExecuteIfBound();
}
