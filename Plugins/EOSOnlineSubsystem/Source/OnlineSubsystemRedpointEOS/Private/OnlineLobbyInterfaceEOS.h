...
private:
    ...
    EOS_HLobby EOSLobby;
    TWeakPtr<class FOnlineSubsystemEOS, ESPMode::ThreadSafe> EOSSubsystem;
    TSharedPtr<class FEOSVoiceManager> VoiceManager;

    TUserIdMap<TMap<FString, FEOSLobbyDetailsHandle>> LastSearchResultsByUser;
