...
{
    UE_LOG(LogRedpointEOSAntiCheat, Verbose, TEXT("Player tracking: %s: Requested to add player"), *UserId.ToString());
...
{
    UE_LOG(LogRedpointEOSAntiCheat, Verbose, TEXT("Player tracking: %s: Requested to remove player"), *UserId.ToString());
