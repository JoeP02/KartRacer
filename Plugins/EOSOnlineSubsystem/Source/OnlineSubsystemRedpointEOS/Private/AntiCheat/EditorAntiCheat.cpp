...
bool FEditorAntiCheat::Exec(UWorld *InWorld, const TCHAR *Cmd, FOutputDevice &Ar)
{
    ...
    {
        UE_LOG(LogRedpointEOS, Verbose, TEXT("Simulating Anti-Cheat kick for first user in session..."));
...
{
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Anti-Cheat: Creating editor AC session."));
...
{
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Anti-Cheat: Destroying editor AC session."));
...
{
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Anti-Cheat: Registering player with editor AC session."));
...
{
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Anti-Cheat: Unregistering player with editor AC session."));
