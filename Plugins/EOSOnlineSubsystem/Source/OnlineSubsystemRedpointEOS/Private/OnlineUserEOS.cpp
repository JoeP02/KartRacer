...
private:
    ...
    TSharedPtr<Redpoint::EOS::Core::IRuntimePlatform> RuntimePlatform;
...
void FEOSUserHelpers::LogInvalidExternalAccountProvider(const FString &ExternalAccountType) const
{
    UE_LOG(
        LogRedpointEOS,
        Error,
...
void FEOSUserHelpers::LogMissingExternalAccountDataForPlatform(const FString &ExternalAccountType) const
{
    UE_LOG(
        LogRedpointEOS,
        Error,
...
void FEOSUserHelpers::LogUsageOfDeprecatedEpicAccountId() const
{
    UE_LOG(
        LogRedpointEOS,
        Warning,
...
void FEOSUserHelpers::LogUsageOfDeprecatedEpicCountry() const
{
    UE_LOG(
        LogRedpointEOS,
        Warning,
