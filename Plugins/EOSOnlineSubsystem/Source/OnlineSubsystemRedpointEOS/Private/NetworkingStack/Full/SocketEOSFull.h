...
private:
    void *Data;
    int32 DataLen;
    TSharedPtr<FEOSPacketTiming> Timing;

public:
    FEOSRawPacket(void *InData, int32 InDataLen, const TSharedPtr<FEOSPacketTiming> &InTiming)
        : Data(InData)
        , DataLen(InDataLen)
        , Timing(InTiming){};
    ...
    const TSharedPtr<FEOSPacketTiming> &GetTiming() const
    {
        return this->Timing;
    }
};
