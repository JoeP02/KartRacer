    ...
    FOnlineExternalCredentialsRefreshComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Authenticating with OSS auth token: %s"), *this->CurrentCredentials.Token);
    ...
    FAuthenticationGraphNodeOnDone InOnDone)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Authenticating with OSS auth token: %s"), *Credentials.Token);
