    ...
    FOnlineExternalCredentialsRefreshComplete OnComplete)
{
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Copying updated refresh token from EOS Auth..."));
    ...
    UE_LOG(LogRedpointEOS, Verbose, TEXT("Successfully obtained updated EAS token for user"));
