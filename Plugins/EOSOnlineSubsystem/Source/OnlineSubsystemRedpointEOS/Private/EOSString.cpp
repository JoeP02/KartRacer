    ...
    char *ExistingPtr)
{
    if (MaxLengthExcludingNullTerminator == EOS_UNLIMITED_MAX_LENGTH)
    {
        UE_LOG(LogRedpointEOS, Error, TEXT("CopyToExistingBuffer called on string type with unlimited length."));
        return EOS_EResult::EOS_LimitExceeded;
    }
...
#endif
#if EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_STRING_TESTS_ANSI_STRING_LENGTH_FOR_TESTS &&                              \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_CONNECT_EXTERNAL_ACCOUNT_ID_MAX_LENGTH &&                                 \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_LOBBY_INVITEID_MAX_LENGTH &&                                              \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_LOBBYMODIFICATION_MAX_ATTRIBUTE_LENGTH &&                                 \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_PRESENCEMODIFICATION_JOININFO_MAX_LENGTH &&                               \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_SESSIONS_INVITEID_MAX_LENGTH &&                                           \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_P2P_SOCKET_NAME_MAX_LENGTH &&                                             \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_PRESENCE_DATA_MAX_KEY_LENGTH &&                                           \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_PRESENCE_DATA_MAX_VALUE_LENGTH &&                                         \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_ATTRIBUTE_MAX_LENGTH &&                                                   \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_PLAYERDATASTORAGE_MD5_MAX_LENGTH &&                                       \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_SESSIONMODIFICATION_MAX_SESSIONIDOVERRIDE_LENGTH &&                       \
    EOS_ECOM_ENTITLEMENTID_MAX_LENGTH != EOS_TITLESTORAGE_TAG_MAX_LENGTH
template class ONLINESUBSYSTEMREDPOINTEOS_API EOSString_AnsiString<EOS_ECOM_ENTITLEMENTID_MAX_LENGTH>;
#endif
