...
IMPLEMENT_MANAGED_ASYNC_AUTOMATION_TEST(
    ...
    "OnlineSubsystemEOS.OnlineSessionInterface.CanFindSessionWeWereRegisteredIn",
...
public:
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Starting CreateSession operation"));
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Starting RegisterPlayer operation"));
    ...
    void Handle_RegisterPlayer(
        ...
        bool bWasSuccessful)
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Handling RegisterPlayers response"));
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Starting FindFriendSession operation"));
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Starting UnregisterPlayer operation"));
    ...
    void Handle_UnregisterPlayer(
        ...
        bool bWasSuccessful)
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Handling UnregisterPlayers response"));
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Starting DestroySession operation"));
    ...
    {
        UE_LOG(LogRedpointEOSTests, Verbose, TEXT("CanFindSessionWeWereRegisteredIn: Handling DestroySession response"));
