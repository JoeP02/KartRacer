...
IMPLEMENT_MANAGED_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks,
    "OnlineSubsystemEOS.OnlinePartyInterface.LeavePartyMultiLocalUserWorks",
    EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter,
    FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager);

class FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager
    : public TSharedFromThis<FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager>,
      public FSingleTestPartyManager
{
public:
    UE_NONCOPYABLE(FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager);
    virtual ~FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager() = default;

    typedef FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager TThisClass;

    class FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks *T;
    ...
    FTSTicker::FDelegateHandle InviteTimeoutHandle;
    ...
    void Handle_ReceiveInviteOnClient(const FUniqueNetId &LocalUserId, const IOnlinePartyJoinInfo &Invitation);
    ...
    FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager(
        class FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks *InT,
        const FMultiplayerScenarioInstance &InHost,
        const FMultiplayerScenarioInstance &InClient,
        const std::function<void()> &InOnDone)
    {
        this->T = InT;
        this->Host = InHost;
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Start_CreatePartyOnHost()
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_CreatePartyOnHost(
    const FUniqueNetId &LocalUserId,
    const TSharedPtr<const FOnlinePartyId> &PartyId,
    const ECreatePartyCompletionResult Result)
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Start_SendInviteToClient()
{
    ...
    UE_LOG(LogRedpointEOSTests, Log, TEXT("Sending invitation"));
    if (!T->TestTrue(
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_SendInviteToClient(
    const FUniqueNetId &LocalUserId,
    const FOnlinePartyId &PartyId,
    const FUniqueNetId &RecipientId,
    const ESendPartyInvitationCompletionResult Result)
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Start_RestoreInvitesOnClient()
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_RestoreInvitesOnClient(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Result)
{
    ...
    {
        this->InviteTimeoutHandle = FTSTicker::GetCoreTicker().AddTicker(
            FTickerDelegate::CreateSP(this, &TThisClass::Handle_InviteTimeout),
            30.0f);
    }
}

void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_ReceiveInviteOnClient(
    const FUniqueNetId &LocalUserId,
    const IOnlinePartyJoinInfo &Invitation)
{
    auto PartyIdRef = Invitation.GetPartyId();
    auto SenderIdRef = Invitation.GetSourceUserId();
    const FOnlinePartyId &PartyId = *PartyIdRef;
    const FUniqueNetId &SenderId = *SenderIdRef;
    ...
    {
        FTSTicker::GetCoreTicker().RemoveTicker(this->InviteTimeoutHandle);
...
bool FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_InviteTimeout(
    float DeltaTime)
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_JoinPartyOnClient(
    const FUniqueNetId &LocalUserId,
    const FOnlinePartyId &PartyId,
    const EJoinPartyCompletionResult Result,
    const int32 NotApprovedReason)
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Start_LeavePartyOnClient()
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Handle_LeavePartyOnClient(
    const FUniqueNetId &LocalUserId,
    const FOnlinePartyId &PartyId,
    const ELeavePartyCompletionResult Result)
{
...
void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager::Start()
{
    this->ClientPartySystemWk.Pin()->AddOnPartyInviteReceivedExDelegate_Handle(
        FOnPartyInviteReceivedExDelegate::CreateSP(this, &TThisClass::Handle_ReceiveInviteOnClient));

    this->RunCount = 0;
    this->Start_CreatePartyOnHost();
}

void FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks::CreateManagingInstance(
    const FOnDone &OnDone,
    const std::function<
        void(const TSharedRef<FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager> &)>
        &OnInstanceCreated)
{
    ...
    CreateUsersForTest_CreateOnDemand(
        ...
        [this, OnInstanceCreated](
            ...
            Client.UserId = UserIds[1];

            auto Instance = MakeShared<FOnlineSubsystemEOS_OnlinePartyInterface_LeavePartyMultiLocalUserWorks_Manager>(
                this,
                Host,
                Client,
                OnDone);
