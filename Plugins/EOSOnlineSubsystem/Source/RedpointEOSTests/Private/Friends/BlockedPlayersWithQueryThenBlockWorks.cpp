...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_Friends_BlockedPlayersWithQueryThenBlockWorks,
    "OnlineSubsystemEOS.Friends.BlockedPlayersWithQueryThenBlockWorks",
    EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_Friends_BlockedPlayersWithQueryThenBlockWorks::RunAsyncTest(
            ...
            *QueryHandle = Friends->AddOnQueryBlockedPlayersCompleteDelegate_Handle(
                FOnQueryBlockedPlayersCompleteDelegate::CreateLambda(
                    [this,
                     ...
                     UserIdEOS = UserId,
                     OtherUserId](const FUniqueNetId &UserId, bool bWasSuccessful, const FString &Error) {
                        ...
                        *BlockHandle = FriendsWk.Pin()->AddOnBlockedPlayerCompleteDelegate_Handle(
                            0,
                            FOnBlockedPlayerCompleteDelegate::CreateLambda([this, OnDone, FriendsWk, UserIdEOS](
                                                                               int32 LocalUserNum,
                                                                               bool bWasSuccessful,
