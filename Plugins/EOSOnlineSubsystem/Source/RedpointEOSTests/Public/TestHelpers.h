...
DECLARE_LOG_CATEGORY_EXTERN(LogRedpointEOSTests, All, All);
...
public:
    ...
    virtual FString GetCloudMessagingHubUrl() const override
    {
        return TEXT("wss://cmh-evedrf4s6q-uc.a.run.app/messaging/v1");
    }
};